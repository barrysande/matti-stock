...
const routes = {
  ...
  'catalogue_categories.preview_merge': {
    methods: ["POST"],
    pattern: '/catalogue-categories/:id/merge-preview',
    tokens: [{"old":"/catalogue-categories/:id/merge-preview","type":0,"val":"catalogue-categories","end":""},{"old":"/catalogue-categories/:id/merge-preview","type":1,"val":"id","end":""},{"old":"/catalogue-categories/:id/merge-preview","type":0,"val":"merge-preview","end":""}],
    types: placeholder as Registry['catalogue_categories.preview_merge']['types'],
  },
  'catalogue_categories.merge': {
    methods: ["POST"],
    pattern: '/catalogue-categories/:id/merge',
    tokens: [{"old":"/catalogue-categories/:id/merge","type":0,"val":"catalogue-categories","end":""},{"old":"/catalogue-categories/:id/merge","type":1,"val":"id","end":""},{"old":"/catalogue-categories/:id/merge","type":0,"val":"merge","end":""}],
    types: placeholder as Registry['catalogue_categories.merge']['types'],
  },
